...
function Emergency_Requests() {
  ...
  return (
    <div className=' flex  h-full bg-white flex-col text-xs gap-4 py-3  px-6   w-full'>
      <button
        onClick={ ()=> setModalsVisibility(state => ({ ...state, isNewRequestModalVisible: true })) }
          ...
          >
            ...
            <button
              onClick={() => {
                ...
                setModalsVisibility(state => ({ ...state, isRequestDetailsModalVisible: true  }));
              }}
...

      {
        ...
        ? <NewEmergencyRequestModal 
            close={ ()=> setModalsVisibility(state => ({ ...state, isNewRequestModalVisible: false })) }
          />
        : null
      }
    </div>
