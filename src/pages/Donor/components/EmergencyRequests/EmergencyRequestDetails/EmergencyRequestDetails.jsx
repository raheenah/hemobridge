        ...
        <Modal>
            ...
            <div className='flex flex-col text-base gap-2'>
                ...
                <p className='flex items-center gap-2'>
                    ...
                    {requestDetails.facilityId?.phoneNumber}
                </p>
            ...
            <div className='flex flex-col text-base gap-2'>
                ...
                <div className='grid  gap-2 grid-cols-2'>
                    ...
                    <input
                        onChange={(e)=> setFormData(state=> ({ ...state, preferredDate: e.target.value }))}
                    ...
                    <input
                        onChange={(e)=> setFormData(state=> ({ ...state, preferredTime: e.target.value }))}
                        className='placeholder-input-text w-full focus:outline-none'
                        type='time'
                        required
                    />
                ...
                <div className={`text-center mt-4 font-medium ${formData.error ? 'text-red-500' : 'text-green-500'}`}>
                    {formData.message}
                </div>
            </div>
        </Modal>
